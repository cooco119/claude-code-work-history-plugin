 ...
 * - Project-level install: {project}/.work-history/{USER}/
 * - Global install: {plugin}/data/{PATH_HASH}/
 *
 * Uses .work-history (not .claude/work-history) for agent-engine agnostic compatibility.
 */
...
function getStorageRoot() {
  ...
  if (installType === 'global') {
    ...
    return path.join(projectDir, '.work-history');
  }
}
